...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2024 a las 00:46:40
...
--
-- Error leyendo la estructura de la tabla chocoaras.usuario: #1932 - Table &#039;chocoaras.usuario&#039; doesn&#039;t exist in engine
-- Error leyendo datos de la tabla chocoaras.usuario: #1064 - Algo está equivocado en su sintax cerca &#039;FROM `chocoaras`.`usuario`&#039; en la linea 1
